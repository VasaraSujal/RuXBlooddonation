...
//   const navigate = useNavigate();
  ...
  useEffect(() => {
    ...
    if (existingRole) {
      console.log(`User has existing role: ${existingRole}, but staying on homepage`);
    }
  }, []);
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-1">
          <div className="flex justify-between items-center text-xs">
            <div className="flex items-center space-x-4">
              ...
              <span>•</span>
              <span className="font-semibold">Fast. Reliable. Life-Saving.</span>
            </div>
            <div className="flex items-center space-x-4">
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-6">
              ...
              {/* Portal Title */}
              <div>
                <h1 className="text-3xl font-bold bg-gradient-to-r from-red-600 to-blue-600 bg-clip-text text-transparent">BloodConnect+</h1>
                <p className="text-sm font-semibold text-red-600">{t('siteTagline')}</p>
                <p className="text-xs text-gray-600">A Unified Network for Blood Management & Emergency Response</p>
              </div>
            </div>
      ...
      <div className="bg-red-600 shadow-sm">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center space-x-8 py-3 text-white text-sm font-medium">
            <Link to="/" className="hover:bg-red-700 px-3 py-2 rounded">{t('home')}</Link>
            <Link to="/blood-banks" className="hover:bg-red-700 px-3 py-2 rounded">{t('bloodBanks')}</Link>
            <Link to="/camps" className="hover:bg-red-700 px-3 py-2 rounded">{t('donationCamps')}</Link>
            <Link to="/statistics" className="hover:bg-red-700 px-3 py-2 rounded">{t('statistics')}</Link>
            <Link to="/about" className="hover:bg-red-700 px-3 py-2 rounded">{t('aboutUs')}</Link>
            <Link to="/contact" className="hover:bg-red-700 px-3 py-2 rounded">{t('contact')}</Link>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-red-50 to-blue-50 py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          {/* Statistics Section */}
          <div className="mt-12">
            <h3 className="text-2xl font-bold text-gray-900 mb-2">{t('statsHeading')}</h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm border">
                <div className="text-2xl font-bold text-green-600">1,45,67,234</div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">{t('accessHeading')}</h2>
            ...
            <div className="bg-gradient-to-r from-red-500 to-red-600 text-white p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-red-100">For individual donors and blood seekers</p>
                </div>
              </div>
            </div>
            <div className="p-6">
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-red-500 rounded-full"></div>
                  <span className="text-gray-700">Search for blood availability</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-red-500 rounded-full"></div>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100">For hospitals and healthcare organizations</p>
                </div>
              </div>
            </div>
            <div className="p-6 bg-blue-50">
              <div className="space-y-3 mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-800 font-medium">Government blood inventory management</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-3 h-3 bg-green-600 rounded-full"></div>
                  <span className="text-gray-800 font-medium">Official blood requests from donors</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-3 h-3 bg-orange-600 rounded-full"></div>
                  <span className="text-gray-800 font-medium">Organize government-approved camps</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-3 h-3 bg-purple-600 rounded-full"></div>
                  <span className="text-gray-800 font-medium">Generate official reports & analytics</span>
                </div>
              </div>
              <button
      ...
      <div className="bg-white py-16 border-t">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8">
            Register yourself as a donor and become part of India's largest blood donation network.
            Every donation can save up to 3 lives.
          </p>
          
          <div className="bg-gray-50 rounded-xl p-8">
            <h4 className="text-lg font-semibold text-gray-800 mb-6">Quick Registration Process</h4>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">Name, age, contact information</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-red-100 text-red-600 rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-xl">🩺</span>
                ...
                <p className="text-sm text-gray-600">Medical eligibility verification</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-red-100 text-red-600 rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-xl">✅</span>
                ...
                <p className="text-sm text-gray-600">Receive donor certificate</p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h4 className="font-semibold text-gray-800">Find Blood Banks</h4>
              </div>
              <p className="text-gray-600 text-sm mb-4">
                Locate nearby blood banks and check real-time availability of blood units across all blood groups.
              </p>
              <Link to="/blood-banks" className="text-red-600 hover:text-red-700 text-sm font-medium">
                View Blood Banks →
              </Link>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Find upcoming blood donation camps in your area. Register to participate and save lives.
              </p>
              <Link to="/camps" className="text-blue-600 hover:text-blue-700 text-sm font-medium">
                View Camps →
              </Link>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600 text-sm mb-4">
                View comprehensive statistics on blood donation trends, availability, and impact across India.
              </p>
              <Link to="/statistics" className="text-green-600 hover:text-green-700 text-sm font-medium">
                View Statistics →
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link to="/blood-banks" className="text-red-200 hover:text-white">{t('bloodBanks')}</Link></li>
                <li><Link to="/camps" className="text-red-200 hover:text-white">{t('donationCamps')}</Link></li>
                <li><Link to="/statistics" className="text-red-200 hover:text-white">{t('statistics')}</Link></li>
                <li><Link to="/about" className="text-red-200 hover:text-white">{t('aboutUs')}</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="#" className="text-red-200 hover:text-white">Red Cross Society</a></li>
                <li><a href="#" className="text-red-200 hover:text-white">WHO Blood Safety</a></li>
                <li><a href="#" className="text-red-200 hover:text-white">Local Hospitals</a></li>
                <li><a href="#" className="text-red-200 hover:text-white">Health Organizations</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-red-700 mt-8 pt-8 text-center">
            <p className="text-red-200 text-sm mb-2">
              {t('footerNote') || '© 2025 BloodConnect | A Public Initiative to Save Lives'}
            </p>
