...
const Camps = () => {
  ...
  const upcomingCamps = [
    {
      ...
      facilities: ["Free Health Checkup", "Refreshments", "Certificate", "Blood Group Testing"],
      status: "Open"
    },
    {
      id: 2,
      ...
      facilities: ["Employee Participation", "Lunch", "Health Screening", "Transportation"],
      status: "Open"
    },
    {
      id: 3,
      ...
      facilities: ["Student Volunteers", "Medical Supervision", "Snacks", "Awareness Session"],
      status: "Nearly Full"
    },
    {
      id: 4,
      ...
      facilities: ["Free Medical Checkup", "Lunch", "Blood Donor Card", "Health Tips"],
      status: "Open"
    },
    {
      id: 5,
      ...
      facilities: ["Expert Medical Team", "Refreshments", "Certificate", "Follow-up Care"],
      status: "Open"
    }
  ];

  const states = ["Delhi", "Maharashtra", "Karnataka", "Uttar Pradesh", "Tamil Nadu", "Gujarat", "Rajasthan", "West Bengal"];
  ...
  const filteredCamps = upcomingCamps.filter(camp => {
    ...
    const matchesMonth = !selectedMonth || camp.date.includes(selectedMonth.split(' ')[1]) || 
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'Nearly Full': return 'bg-yellow-100 text-yellow-800 border-yellow-200';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-blue-900">Blood Donation Camps</h1>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <div className="flex items-center space-x-2 mb-2">
                <h3 className="text-lg font-bold text-orange-800 uppercase tracking-wide">Official Blood Donation Camps</h3>
                <div className="bg-green-600 text-white px-2 py-1 rounded text-xs font-bold">VERIFIED</div>
              </div>
              <p className="text-gray-700 leading-relaxed">
                <strong>Government approved</strong> blood donation camps listed below. All camps follow national safety guidelines and are supervised by qualified medical professionals. 
                <span className="text-blue-700 font-semibold">Join community service and save lives.</span>
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12 border-t-4 border-blue-600">
          <div className="flex items-center mb-6">
            ...
            <div>
              <h2 className="text-xl font-bold text-blue-900">Search Government Verified Camps</h2>
              <p className="text-sm text-gray-600">Find authorized blood donation camps across India</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-6 border-t-2 border-gray-200">
            <div className="text-center bg-blue-50 p-4 rounded-lg">
              <div className="text-2xl font-bold text-blue-700">{filteredCamps.length}</div>
              <div className="text-sm text-gray-700 font-medium">Camps Found</div>
            </div>
            <div className="text-center bg-green-50 p-4 rounded-lg">
              <div className="text-2xl font-bold text-green-700">
                {filteredCamps.filter(c => c.status === 'Open').length}
              </div>
              <div className="text-sm text-gray-700 font-medium">Open Registration</div>
            </div>
            <div className="text-center bg-orange-50 p-4 rounded-lg">
              <div className="text-2xl font-bold text-orange-700">
                {filteredCamps.reduce((sum, camp) => sum + camp.target, 0)}
              </div>
              <div className="text-sm text-gray-700 font-medium">Target Donors</div>
            </div>
            <div className="text-center bg-red-50 p-4 rounded-lg">
              <div className="text-2xl font-bold text-red-700">
                {filteredCamps.reduce((sum, camp) => sum + camp.registered, 0)}
              </div>
              <div className="text-sm text-gray-700 font-medium">Already Registered</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-green-50 rounded-lg p-8 mb-12 border-l-8 border-green-600 shadow-lg">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Organize Government Approved Blood Camp</h2>
            <p className="text-lg text-gray-700 mb-6 max-w-3xl mx-auto">
              Apply to organize blood donation camps in your organization, college, or community under government supervision. 
              Complete support provided including medical equipment, trained staff, and official certification.
            </p>
        ...
        <div className="space-y-6">
          {filteredCamps.length === 0 ? (
            <div className="bg-white rounded-xl shadow-lg p-12 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-4">No Camps Found</h3>
            ...
            filteredCamps.map(camp => (
              <div key={camp.id} className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow p-8 border-l-8 border-blue-600">
                  ...
                  <div className="flex-1 lg:pr-8">
                    ...
                    <div className="flex items-start justify-between mb-6">
                      <div>
                        <div className="flex items-center mb-2">
                          <h3 className="text-xl font-bold text-blue-900 mr-3">{camp.name}</h3>
                          <div className="bg-green-600 text-white px-3 py-1 rounded text-xs font-bold">
                            GOVT VERIFIED
                          </div>
                        </div>
                        <p className="text-gray-700 mb-4">
                          <span className="font-semibold">Organized by:</span> {camp.organizer}
                        </p>
                        <div className={`inline-block px-4 py-2 rounded-lg text-sm font-semibold border-2 ${getStatusColor(camp.status)}`}>
                          {camp.status}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                      <div className="bg-blue-50 p-4 rounded-lg">
                        ...
                        <div className="space-y-3 text-sm">
                          <div className="flex items-center">
                            ...
                            <span className="text-gray-700 font-medium">📅 {new Date(camp.date).toLocaleDateString('en-IN', { 
                              weekday: 'long', 
                              year: 'numeric', 
                              month: 'long', 
                              day: 'numeric' 
                          ...
                          <div className="flex items-center">
                            ...
                            <span className="text-gray-700 font-medium">🕒 {camp.time}</span>
                          </div>
                          <div className="flex items-center">
                            <div className="w-3 h-3 bg-orange-600 rounded-full mr-3"></div>
                            <span className="text-gray-700 font-medium">📍 {camp.venue}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="space-y-2 text-sm">
                          <div className="text-gray-700 font-medium">👨‍⚕️ {camp.contactPerson}</div>
                          <div className="text-gray-700 font-medium">📞 {camp.phone}</div>
                          <div className="text-gray-700 font-medium">✉️ {camp.email}</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mb-6 bg-white border-2 border-gray-200 rounded-lg p-4">
                      <div className="flex justify-between items-center mb-3">
                        <span className="font-bold text-gray-800">📊 Registration Status</span>
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-4 border">
                        <div 
                          ...
                          style={{ width: `${Math.min((camp.registered / camp.target) * 100, 100)}%` }}
                        ></div>
                      </div>
                    </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-800 to-blue-900 rounded-lg text-white p-12 shadow-lg">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center bg-white bg-opacity-10 p-6 rounded-lg">
              ...
              <h3 className="text-xl font-bold mb-4">Government Medical Standards</h3>
              <p className="text-blue-100">
                Qualified medical professionals ensure safe donation with government-approved screening protocols and equipment.
              </p>
            </div>
            <div className="text-center bg-white bg-opacity-10 p-6 rounded-lg">
              <div className="text-4xl mb-4">🎁</div>
              <h3 className="text-xl font-bold mb-4">Official Benefits</h3>
              <p className="text-blue-100">
                Free health checkups, refreshments, government certificates, and donor recognition by health authorities.
              </p>
            </div>
            <div className="text-center bg-white bg-opacity-10 p-6 rounded-lg">
              <div className="text-4xl mb-4">🤝</div>
              <h3 className="text-xl font-bold mb-4">National Service</h3>
              <p className="text-blue-100">
                Contribute to national blood reserves and serve the nation by helping patients in emergency situations.
              </p>
            </div>
          </div>
        </div>
